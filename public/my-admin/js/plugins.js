...
(function($){ 
	$.fn.shortPass = 'Muy d\u00E9bil';
	$.fn.badPass = 'D\u00E9bil';
	$.fn.goodPass = 'Medio';
	$.fn.strongPass = 'Fuerte';
	$.fn.samePassword = 'Nombre de usuario y contrase\u00F1a identicos.';
	$.fn.resultStyle = "";
...
function init(elem,opts,selector) {
	...
	$(document).off("click", ".cee_close").on("click", ".cee_close", function(){$.fn.ceebox.closebox();return false;}); //adds close button functionality
...
function addGallery(g,family,opts){ // adds gallery next/prev functionality
	...
	$("#cee_title").append("<div id='cee_count'>" + (g.gNum+1) +" / "+ g.gLen + "</div>");
}
